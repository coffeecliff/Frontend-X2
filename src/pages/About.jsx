...
export const About = () => {
  return (
    <div className="w-full min-h-screen bg-dark flex flex-col items-center px-6 py-12">
      ...
      {/* Conteúdo */}
      <div className="max-w-3xl text-sm md:text-base text-justify space-y-6 text-light">
        ...
        <section>
          <h2 className="font-bold text-accent mb-2">▶ REGRAS DE JOGO</h2>
          <ul className="list-disc ml-6">
        ...
        <section>
          <h2 className="font-bold text-accent mb-2">▶ CONDUTA E PENALIDADES</h2>
          <ul className="list-disc ml-6">
        ...
        <section>
          <h2 className="font-bold text-accent mb-2">▶ PREMIAÇÃO</h2>
          <ul className="list-disc ml-6">
